...
CREATE_TABLE_SERVICE = """ CREATE TABLE IF NOT EXISTS servise
                            (ID INTEGER PRIMARY KEY,
                            LINK TEXT)
                            
"""
INSERT_SERVICE = """INSERT OR IGNORE INTO servise VALUES (?,?)
"""

CREATE_TABLE_SERVICE_QUERY = """
...
INSERT OR IGNORE INTO service_data VALUES (?,?,?)
"""